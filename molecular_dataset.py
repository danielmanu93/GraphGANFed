...
def data_noniid(dataset, num_users):
    ...
    mol_data.generate('C:\\Users\\DANIEL\\Desktop\\fedgan\\data_smiles\\esol_smiles.pkl', validation=0.1, test=0.1)
    data = mol_data.data
...
if __name__ == '__main__':
    ...
    data.generate('C:\\Users\\DANIEL\\Desktop\\fedgan\\data_smiles\\esol_smiles.pkl', validation=0.1, test=0.1)
    data.save('C:\\Users\\DANIEL\\Desktop\\fedgan\\data_smiles\\esol.dataset')